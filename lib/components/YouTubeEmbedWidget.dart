...
class YouTubeEmbedWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return IgnorePointer(
      ignoring: true,
      child: Html(
        data: fullIFrame.validate() ? videoId : '<html><iframe height="230" style="width:100%" src="$path" allow="autoplay; fullscreen" allowfullscreen="allowfullscreen"></iframe></html>',
      ),
    ).onTap(() {
